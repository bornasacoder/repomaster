...
class Common_model extends CI_Model 
{
  ...
  public function updateData($tab,$data,$whr)
  {
	...
	public function getUserProfile($whr,$orderby) {
		...
		case when u.profile_pic is not null then concat('http://espsofttechnologies.com/freedomcell/uploads/users_profile/', u.profile_pic) else 'https://cdn-icons-png.flaticon.com/512/6596/6596121.png' end as profile_pic,
		api_key,
